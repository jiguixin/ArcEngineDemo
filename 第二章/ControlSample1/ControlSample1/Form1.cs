    ...
    public partial class ControlSample1 : Form
    {
        ...
        private void loadEagleEyeDocument(String filePath)
        {
            if (axMapControl2.CheckMxFile(filePath))
            {
                ...
                //axMapControl2.MapScale = this.axMapControl1.MapScale * 2;
                //setLoadEagle();
            }
            else
            {
        ...
        {
            //axMapControl2.MapScale = this.axMapControl1.MapScale * 10.0;
            IPoint point = new PointClass();
...
//            IActiveView pAv = pGra as IActiveView;
            IActiveView pAv = axMapControl2.Map as IActiveView;
